  ...
  'PageRank': {
    'CPU分布式': {
      1: [
        {
          'Dataset': 'Rmat-16',
          'Baseline-Time(s)': 50.0,
          'Dataflow-Time(s)': 20.8,
          'Baseline-Throughput': 0.5, // GTEPS
          'Dataflow-Throughput': 1.35  // GTEPS
        },
        {
          'Dataset': 'Rmat-18',
          'Baseline-Time(s)': 169.2,
          'Dataflow-Time(s)': 86.8,
          'Baseline-Throughput': 0.55, // GTEPS
          'Dataflow-Throughput': 1.03  // GTEPS
        },
        {
          'Dataset': 'Rmat-20',
          'Baseline-Time(s)': 312.8,
          'Dataflow-Time(s)': 31.2,
          'Baseline-Throughput': 0.6, // GTEPS
          'Dataflow-Throughput': 6.15 // GTEPS
        }
      ],
      2: [
        {
          'Dataset': 'Rmat-16',
          'Baseline-Time(s)': 25.0,
          'Dataflow-Time(s)': 10.4,
          'Baseline-Throughput': 1.0, // GTEPS
          'Dataflow-Throughput': 2.7  // GTEPS
        },
        {
          'Dataset': 'Rmat-18',
          'Baseline-Time(s)': 84.6,
          'Dataflow-Time(s)': 43.4,
          'Baseline-Throughput': 1.1, // GTEPS
          'Dataflow-Throughput': 2.05  // GTEPS
        },
        {
          'Dataset': 'Rmat-20',
          'Baseline-Time(s)': 156.4,
          'Dataflow-Time(s)': 15.6,
          'Baseline-Throughput': 1.2, // GTEPS
          'Dataflow-Throughput': 12.3 // GTEPS
        }
      ],
      4: [
        {
      ...
      8: [
        {
          'Dataset': 'Rmat-16',
          'Baseline-Time(s)': 6.25,
          'Dataflow-Time(s)': 2.6,
          'Baseline-Throughput': 4.2, // GTEPS
          'Dataflow-Throughput': 10.8  // GTEPS
        },
        {
          'Dataset': 'Rmat-18',
          'Baseline-Time(s)': 21.15,
          'Dataflow-Time(s)': 10.85,
          'Baseline-Throughput': 4.4, // GTEPS
          'Dataflow-Throughput': 8.2  // GTEPS
        },
        {
          'Dataset': 'Rmat-20',
          'Baseline-Time(s)': 39.1,
          'Dataflow-Time(s)': 3.9,
          'Baseline-Throughput': 4.8, // GTEPS
          'Dataflow-Throughput': 49.2 // GTEPS
        }
      ]
    },
    'GPU': {
  ...
  'ViT': {
    'CPU分布式': {
      1: [
        {
          'Dataset': 'ImageNet',
          'Baseline-Time(s)': 660.0,
          'Dataflow-Time(s)': 408.0,
          'Baseline-Throughput': 80, // GFLOPS
          'Dataflow-Throughput': 127.5  // GFLOPS
        },
        {
          'Dataset': 'DriveSeg',
          'Baseline-Time(s)': 468.0,
          'Dataflow-Time(s)': 294.0,
          'Baseline-Throughput': 57.5, // GFLOPS
          'Dataflow-Throughput': 95  // GFLOPS
        }
      ],
      2: [
        {
          'Dataset': 'ImageNet',
          'Baseline-Time(s)': 330.0,
          'Dataflow-Time(s)': 204.0,
          'Baseline-Throughput': 160, // GFLOPS
          'Dataflow-Throughput': 255  // GFLOPS
        },
        {
          'Dataset': 'DriveSeg',
          'Baseline-Time(s)': 234.0,
          'Dataflow-Time(s)': 147.0,
          'Baseline-Throughput': 115, // GFLOPS
          'Dataflow-Throughput': 190  // GFLOPS
        }
      ],
      4: [
        {
      ...
      8: [
        {
          'Dataset': 'ImageNet',
          'Baseline-Time(s)': 82.5,
          'Dataflow-Time(s)': 51.0,
          'Baseline-Throughput': 640, // GFLOPS
          'Dataflow-Throughput': 1020  // GFLOPS
        },
        {
          'Dataset': 'DriveSeg',
          'Baseline-Time(s)': 58.5,
          'Dataflow-Time(s)': 36.75,
          'Baseline-Throughput': 460, // GFLOPS
          'Dataflow-Throughput': 760  // GFLOPS
        }
      ]
    },
    'GPU': {
